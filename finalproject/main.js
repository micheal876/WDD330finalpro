...
function getExpenses() {
    ...
    document.getElementById('expenseOutput').innerHTML = "Amount for food: $" + foodPercentage + "<br/>" 
                                                        + "Amount for entertainment: $" + entertainmentPercentage + "<br/>"
                                                        + "Amount for clothes: $" + clothesPercentage + "<br/>"
                                                        + "Amount for charity: $" + charityPercentage + "<br/>"
                                                        + "Amount for other: $" + otherPercentage; 
